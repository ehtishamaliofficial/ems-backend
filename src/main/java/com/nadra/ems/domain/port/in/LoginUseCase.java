...
public interface LoginUseCase {
     ...
     * @return {@link LoginResult} containing scoped token and 2FA status
     */
    LoginResult login(String usernameOrEmail, String rawPassword, String clientIp);
     ...
     */
    AuthTokenResult verifyTwoFactorLogin(String twoFactorToken, String totpCode, String clientIp);
}
